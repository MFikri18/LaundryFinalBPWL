        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-4">
                    <h2 class="heading-section">Data Transaksi</h2>
                        <a class="tombol" href="inputtransaksi.html">+ Tambah Data Baru</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                          ...
                          <?php 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                    <a href="editservices.php?kode_transaksi=<?php echo $d['kode_transaksi'];?>&aksi=update"><button type="button" class="btn btn-danger">EDIT</button></a>
                                    <a href="formhapustransaksi.php?kode_transaksi=<?php echo $d['kode_transaksi'];?>&aksi=hapus"><button type="button" class="btn btn-danger">HAPUS</button></a>
                                    </td>
                                </tr> 
                                <?php 
                                }
