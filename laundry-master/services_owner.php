    ...
    <header>
                ...
                <div class="header-left">
                    ...
                    <div class="menu-wrapper  d-flex align-items-center">
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav> 
                                <ul id="navigation">                                                                                          
                                    <li><a href="indexowner.html">Beranda</a></li>
                                    <li class="active"><a href="services_owner.php">Data Transaksi</a></li>
        ...
        function Keluar(){
            ...
            if(hapus){
                ...
                window.location.href='services_owner.php';
            }
        }
    </script>
                                </ul>
                          ...
                          <?php 
			                ...
			                ?>
			                    <tr>
                                    ...
                                    <td><a href="Cetak/cetakdata.php"><button type="button" class="btn btn-danger">CETAK</button></a>
                                    </td>
                                </tr> 
                                <?php 
		                        }
